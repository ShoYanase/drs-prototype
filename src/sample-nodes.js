function make_nodes(parag_len, arr_labels){
...
function make_edges(points_matrix, thres){
...
arr_labels = ["図26、図27より、バッファサイズが大きくなる程実行時間が短くなることがわかる.",
...
function act_mynetwork(arr_labels, points_matrix, thres){
  console.log(points_matrix)
  let parag_len = arr_labels.length;
  var container = document.getElementById('mynetwork');
  var data = {
    nodes: make_nodes(parag_len, arr_labels),
    edges: make_edges(points_matrix, thres)
  };
  var options = {
    layout: {
      hierarchical: {
